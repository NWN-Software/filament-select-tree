...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div wire:key="{{ $this->getId() }}.{{ $getStatePath() }}.{{ $field::class }}.item" wire:ignore x-data
        x-load-css="[
        ...
        <div x-ignore ax-load="visible"
            ...
            <x-filament::input.wrapper :suffix="$suffixLabel" :prefix="$prefixLabel" :prefix-icon="$prefixIcon" :suffix-icon="$suffixIcon"
                :disabled="$isDisabled()" :prefix-actions="$prefixActions" :suffix-actions="$suffixActions">
                <div x-ref="tree"></div>
